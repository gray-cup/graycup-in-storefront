...
export default function CheckoutPage() {
  ...
  }, [items, isPending, cartLoading, buyNowLoaded, navigate]);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 lg:px-6">
      <div className="mb-6 flex items-center justify-between gap-4">
        <Link
          to={buyNowSource ? buyNowSource.href : isBuyNow ? "/products" : "/cart"}
            ...
            {user ? (
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-500 bg-gray-50 rounded-lg p-3">
                  ...
                  <Link to="/auth/login?redirect=/checkout" className="text-black underline underline-offset-2 font-medium">
                    Sign in
                  </Link>{" "}
