...
export function meta() {
  const title = "Instant Coffee vs Brewed Coffee: Which Is Right for You? | Gray Cup Guides";
  const description =
    "A practical comparison of instant and brewed coffee - flavour, convenience, quality, and when each one is the right choice.";
  const image = "https://graycup.in/og/guides/instant-vs-brewed-coffee.png";
  return [
    { title },
    ...
    { property: "og:url", content: "https://graycup.in/guides/instant-vs-brewed-coffee" },
