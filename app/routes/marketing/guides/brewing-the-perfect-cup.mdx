...
export function meta() {
  const title = "How to Brew the Perfect Cup of Tea | Gray Cup Guides";
  const description =
    "Master the art of tea brewing - water temperature, steeping times, and techniques for every type of tea.";
  const image = "https://graycup.in/og/guides/brewing-the-perfect-cup.png";
  return [
    { title },
    ...
    { property: "og:url", content: "https://graycup.in/guides/brewing-the-perfect-cup" },
