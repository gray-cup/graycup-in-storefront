...
// Pack sizes on offer, and the discount by a single line's total weight:
// over 1kg -> 5%, over 5kg -> 15% (the cap).
export const FUNDRAISER_SIZES = ["250g", "500g", "1kg"];
export function fundraiserDiscount(totalGrams: number): number {
  return totalGrams > 5000 ? 0.15 : totalGrams > 1000 ? 0.05 : 0;
}
...
export const fundraiserProducts: Product[] = [
  {
    ...
    description:
      "Buy any of our coffees - 250g, 500g or 1kg, roasted to your choice - at our regular prices and the money goes toward our Aillio Bullet R2 roaster. Orders over 1kg get 5% off, and over 5kg 15% off.",
    longDescription:
      "We're raising funds to buy an Aillio Bullet R2 - a ₹6,13,000 electric coffee roaster that will let us roast in-house with far tighter control over batch quality and consistency than our current setup. Pick any of our available coffees in 250g, 500g or 1kg at its regular price, roasted to the level you choose - Light, Medium, Medium-Dark or Dark - and the whole amount goes toward the roaster. Orders over 1kg get 5% off, and over 5kg 15% off. The progress bar on the fundraiser page updates as soon as your payment is confirmed.",
    details: [
      "Regular coffee prices in 250g, 500g and 1kg packs",
      "5% off orders over 1kg, 15% off over 5kg",
