...
export const filterCoffeeProducts: Product[] = reviseRetailCoffeePricing([
  ...
  },
  {
    ...
    variants: [
      { name: "250g", price: 460, weightGrams: 250 },
      { name: "500g", price: 820, weightGrams: 500 },
      { name: "1kg", price: 1580, weightGrams: 1000 },
    ],
    packaging: ["250g pack", "500g pack", "1kg pack"],
  ...
  {
    slug: "filter-coffee-90-arabica-10-chicory",
    name: "Filter Coffee (90% Arabica, 10% Chicory)",
    skipPriceRevision: true,
    image: "/products/ground-coffee.png",
    images: ["/products/ground-coffee.png", "/products/roasted-coffee-beans.png", "/products/green-coffee-beans.png"],
    description:
      "Chicory Arabica filter coffee: 90% Arabica and 10% roasted chicory - mostly Arabica aroma and sweetness, with just a touch of chicory for a smooth, mellow finish.",
    longDescription:
      "Our 90/10 filter coffee with chicory is led by Arabica for aroma, sweetness and body, with a light 10% addition of roasted chicory to round off the edges and add a gentle, classic mellowness without the fuller earthiness of a 70/30 blend. Ground fine for traditional South Indian filter brewing, it delivers a bright, comforting decoction-style cup.",
    details: [
      "Chicory Arabica filter coffee - 90% Arabica, 10% roasted chicory",
      "Bright, aromatic, gently mellow finish",
      "Traditional South Indian filter grind",
      "Lighter on chicory than the classic 70/30 blend",
      "Ideal for filter/decoction brewing",
    ],
    process: "Washed",
    varietal: "Pending",
    roast: "Pending",
    flavourNotes: ["Caramel", "Nutty", "Citrus"],
    specs: [
      { label: "Arabica Process", value: "Washed" },
      { label: "Arabica Origin", value: "Chikmagalur, Coorg" },
    ],
    ...
    variants: [
      { name: "250g", price: 520, weightGrams: 250 },
      { name: "500g", price: 925, weightGrams: 500 },
      { name: "1kg", price: 1790, weightGrams: 1000 },
    ],
    packaging: ["250g pack", "500g pack", "1kg pack"],
    sku: "GC-COF-FLTRAC9010-001",
    brand: "Gray Cup",
    availability: "in_stock",
    googleProductCategory: "1868",
  },
