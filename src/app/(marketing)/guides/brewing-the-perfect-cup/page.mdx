...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Master the art of tea brewing - water temperature, steeping times, and techniques for every type of tea.",
    type: "article",
    url: "/guides/brewing-the-perfect-cup",
    images: ["/og/guides/brewing-the-perfect-cup.png"],
  },
  twitter: {
